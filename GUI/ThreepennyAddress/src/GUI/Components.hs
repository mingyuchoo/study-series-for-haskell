...
createContactRow contact isSelected selectedVar refreshList = do
    ...
    deleteBtn <- UI.button # set text "x"
                           # set UI.style
    ...
    void $ element row #+ [element selectCell, element nameCell, element phoneCell, element emailCell, element addressCell, element actionsCell]
